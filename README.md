...
又称**牛顿-拉弗森方法**（Newton-Raphson method），是一种用于求解实数域或复数域方程近似解的迭代方法。牛顿法的核心思想是利用函数在接近零点附近的切线来逼近零点，并通过反复迭代逐渐收敛到方程的根。具体步骤如下：
...
AUC(Area Under Curve)，指的是[ROC曲线](https://so.csdn.net/so/search?q=ROC曲线&spm=1001.2101.3001.7020)(下图黄色的线)下的面积，ROC相关知识参见西瓜书，常见的实现方法包括下列两种，请你分别补全 AUC_cal 脚本中的方法完成 AUC 的计算

1. 面积法
1. 排序法

![在这里插入图片描述](https://chenxia31blog.oss-cn-hangzhou.aliyuncs.com/blog/0bacd643223e80c23a129dccde7c7eb1.png)
